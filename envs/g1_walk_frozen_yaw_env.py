...
W_KNEE_BEND = 0.0  # ugaseno - savijanje kolena vise nije bitno samo po sebi,
                   # prioritet je razmak/duzina koraka (W_STRIDE) i podizanje
                   # stopala (W_FOOT_LIFT); W_KNEE_STANCE_PENALTY ostaje (noga
                   # da bude prava dok stoji na podu, to jos vazi)
