#!/usr/bin/env python3
"""PPO trening: G1 uci da napravi dva koraka napred, hip_yaw zakljucan.

Posebna kopija train_ppo_walk.py - koristi envs/g1_walk_frozen_yaw_env.py
(10-akcijska varijanta), da se ne dira deljeni envs/g1_walk_env.py koji
koristi Task 3 (play_walk_then_throw.py) preko frozen_test.zip checkpointa.
...
def main():
    ...
    parser.add_argument(
        "--output", type=Path, default=ROOT / "policies" / "g1_walk_ppo_v2_frozenyaw"
    )
    parser.add_argument(
