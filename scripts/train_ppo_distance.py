#!/usr/bin/env python3
"""PPO trening: G1 baca loptu sto dalje (Task 1), posebna kopija bez uticaja
na Task 2/3 (koji koriste envs/g1_free_throw_env.py).
...
def main():
    ...
    parser.add_argument(
        "--output", type=Path, default=ROOT / "policies" / "g1_free_throw_ppo_distance_v2"
    )
    parser.add_argument(
